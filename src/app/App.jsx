...
const projects = [
	{
		...
		link: 'https://github.com/gwc-sys',
		github: 'https://github.com/gwc-sys/Wordpress-Enterprise',
		...
		<div className={style.app}>
			...
			<div id='Home' className={style.home}>
				<div className={style["home-content"]}>
					<h1>HEY, I'M Mahesh Raskar</h1>
					<h1>Fullstack Developer | Cloud Engineer</h1>
					<p>Building scalable, efficient, and user-friendly applications with modern web technologies and cloud platforms.</p>
					<a
						href={cv}
				...
				<div className={style["contact-nav"]}>
					<a className={style.github} target="_blank" href='https://github.com/gwc-sys' >
						<AiFillGithub size="30px" color='black' />
					</a>
					<a className={style.linkedin} target="_blank" href='https://www.linkedin.com/in/mahesh-r-0a109b20a/' >
						<AiFillLinkedin size="30px" color='black' />
					</a>
					<a className={style.gmail} target="_blank" href="mailto:Mahesh-Raskar@outlook.com?subject=SendMail&body=Description" >
						<BiLogoGmail size="30px" color='black' />
					</a>
					<a className={style.facebook} target="_blank" href='https://github.com/gwc-sys' >
				...
				<div className={style.container}>
					...
					<div className={style["about-content"]}>
						<div className={style["about-info"]}>
							...
							<h2>Fullstack Developer | Cloud Engineer</h2>
							<p>
								I'm a <span>Fullstack Developer</span> and <span>Cloud Engineer</span> building scalable and efficient web applications that drive the success of the overall product. Check out some of my work in the <span>Projects</span> section. <br /><br />
								I also enjoy sharing content related to <span>Web Development</span> and <span>Cloud Engineering</span> to help others in the developer community. Feel free to connect or follow me on my <a href="https://github.com/gwc-sys" target="_blank">GitHub</a> where I post useful content related to development and cloud technologies. <br /><br />
				...
				<div className={style.container}>
					<div className={style["footer-info"]}>
						...
						<div className={style.social}>
							<h3>Social</h3>
							<div className="">
								<a className={style.git} target="_blank" href='https://github.com/gwc-sys' >
					...
					<div className={style["copy-right"]}>
						© Copyright 2023. Made by <span>Mahesh Raskar</span>
					</div>
				</div>
			</div>
		</div>
